  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2">
      <div className="rounded-3xl border border-slate-900 bg-slate-900/30 p-8">
        <h1 className="text-3xl font-semibold text-white">Welcome back to VeriLens</h1>
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-4">
          ...
          <div className="text-center text-sm text-slate-400">
            New here?{' '}
            <Link to="/register" className="font-semibold text-slate-200 hover:underline">
              Create an account
            </Link>
          </div>
        </form>
      ...
      <div className="rounded-3xl border border-slate-900 bg-gradient-to-br from-slate-900/40 to-slate-950 p-8">
        <div className="rounded-2xl border border-slate-900 bg-slate-950/40 p-6">
          <div className="text-xs font-semibold text-slate-400">What you get</div>
          <div className="mt-2 text-lg font-semibold text-white">A smarter daily news experience</div>
        ...
        <div className="mt-6 rounded-2xl border border-slate-900 bg-slate-900/30 p-6">
          <div className="text-xs font-semibold text-slate-400">Tip</div>
