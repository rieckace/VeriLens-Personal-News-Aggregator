  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-900 bg-slate-900/30 p-6">
        ...
        <p className="mt-1 text-sm text-slate-300">Your saved articles for later reading.</p>
        {error ? (
      ...
      {loading ? (
        ...
        <div className="rounded-3xl border border-slate-900 bg-slate-900/30 p-10 text-center">
          <div className="text-lg font-semibold text-white">No bookmarks yet</div>
          <div className="mt-2 text-sm text-slate-400">Bookmark articles from your feed to see them here.</div>
        </div>
      )}
    </div>
  )
