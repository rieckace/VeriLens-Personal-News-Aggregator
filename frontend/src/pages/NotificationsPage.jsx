  ...
  return (
    <div className="space-y-6" data-testid="notifications-page">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 data-testid="notifications-title" className="text-2xl font-semibold text-slate-900 dark:text-white">Notifications</h1>
      ...
      {items.length === 0 ? (
        <div data-testid="notifications-empty" className="rounded-3xl border border-slate-200 bg-white p-8 text-slate-700 dark:border-slate-900 dark:bg-slate-900/30 dark:text-slate-300">
          No notifications yet.
        </div>
      ) : (
        <div data-testid="notifications-list" className="overflow-hidden rounded-3xl border border-slate-200 bg-white dark:border-slate-900 dark:bg-slate-900/20">
